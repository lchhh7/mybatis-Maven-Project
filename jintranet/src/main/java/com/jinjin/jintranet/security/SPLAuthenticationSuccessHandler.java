...
public class SPLAuthenticationSuccessHandler implements AuthenticationSuccessHandler {
	
	private static final Logger LOGGER = LoggerFactory.getLogger(SPLAuthenticationSuccessHandler.class);
	...
	public SPLAuthenticationSuccessHandler() {
		targetUrlParameter = "";
		defaultUrl = "/main.do";
		useReferer = false;
	}
	...
	public void onAuthenticationSuccess(HttpServletRequest request,
		...
		LOGGER.info("in success" + intRedirectStrategy);
