<%@ page language="java" contentType="text/html; charset=utf-8"
         pageEncoding="utf-8" %>
<div class="modal" id="admin-excel-yearchoiceModal">
    <div class="modal_wrap" style="z-index: 999;">
        ...
        <form id="choice-form">
            <div class="modal_content">
                ...
                <div class="mbtnbox">
                    <a role="button" id="admin-yearchoice-btn" class="btn jjblue">확인</a>
                    <a role="button" id="admin-yearchoice-close-btn" class="btn jjblue">닫기</a>
                </div>
            </div>
        </form>
    </div>
