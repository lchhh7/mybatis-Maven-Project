    ...
    */
    ...
    function buildNativeFormattingFunc(standardDateProps, extendedSettings, context) {
        ...
        return function (date) {
            ...
            // dhlee
            var l = s.length - 1;
            if (s.charAt(l) === '일' && l > 0) s = s.substr(0, l);
    ...
    */
    ...
    var Toolbar = /** @class */ (function (_super) {
        ...
        Toolbar.prototype.renderLayout = function (layout) {
			...
			if (el.lastChild.querySelector('.fc-legend-button')) {
            	el.lastChild.querySelector('.fc-legend-button').style.display = "none";
            	const legendBox = htmlToElement('<div class="legendBox"></div>');
            	const legendTxt = htmlToElement('<span class="legendTxt">승인된 근태요청</span>');
				const legendBox2 = htmlToElement('<div class="legendBox2"></div>');
            	const legendTxt2 = htmlToElement('<span class="legendTxt2">근태수정요청</span>');
            	el.lastChild.querySelector('.fc-prev-button').before(legendBox);
            	el.lastChild.querySelector('.fc-prev-button').before(legendTxt);
				el.lastChild.querySelector('.fc-prev-button').before(legendBox2);
            	el.lastChild.querySelector('.fc-prev-button').before(legendTxt2);	
        	}
        };
